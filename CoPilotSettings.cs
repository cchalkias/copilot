...
namespace CoPilot
{
    public class CoPilotSettings : ISettings
    {
        ...
        public HotkeyNode custom1Key = new HotkeyNode(Keys.R);
        ...
        public HotkeyNode custom2Key = new HotkeyNode(Keys.E);
        ...
        public HotkeyNode custom3Key = new HotkeyNode(Keys.W);
        ...
        public HotkeyNode custom4Key = new HotkeyNode(Keys.Q);
        ...
        public HotkeyNode custom6Key = new HotkeyNode(Keys.NumPad4);
